...
class ProfilesTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->integer('personal_details')
            ->allowEmptyString('personal_details')
            ->add('personal_details', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);

        $validator
            ->integer('acadamic_qualification')
            ->allowEmptyString('acadamic_qualification');
    ...
    public function buildRules(RulesChecker $rules): RulesChecker
    {
        ...
        $rules->add($rules->isUnique(['personal_details'], ['allowMultipleNulls' => true]), ['errorField' => 'personal_details']);
